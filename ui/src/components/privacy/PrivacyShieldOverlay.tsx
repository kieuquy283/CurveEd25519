...
export default function PrivacyShieldOverlay({ active, mode = "black", onUnlock }: PrivacyShieldOverlayProps) {
  ...
  const toneClass = mode === "blur" ? "bg-black/90 backdrop-blur-xl" : "bg-black";

  return createPortal(
    <div className={`fixed inset-0 z-[10000] ${toneClass} flex items-center justify-center p-6`} role="dialog" aria-modal="true">
